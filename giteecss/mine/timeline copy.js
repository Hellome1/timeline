...
Tess.prototype = Object.create({hello: "hello"}, {p: {value: "person"}});
Tess.prototype.p = 22;
console.log(Tess.prototype); // {p: 'person'}
console.log(Tess.prototype.__proto__); // {hello: 'hello'}
console.log(Object.getOwnPropertyDescriptors(Tess.prototype));
 */